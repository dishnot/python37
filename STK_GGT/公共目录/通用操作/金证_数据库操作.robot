...
金证_买卖委托表数据查询
    ...
    ...    ELSE IF    '${接口或表名称}' in ('可用股份查询_10303002','STK_ASSET')    Set Variable    CUACCT_CODE='${资金账户_全局变量}' and STK_CODE ='${证券代码_全局变量}' and \ STKPBU = '${客户信息['STKPBU']}' \ ORDER BY STK_CODE
    ...
    ...    ELSE IF    '${接口或表名称}' in ('STK_ORDER_DETAIL')    Set Variable    CUACCT_CODE='${资金账户_全局变量}' and STK_CODE ='${证券代码_全局变量}'
    #表
