...
*** Keywords ***
金证_普通买卖检查流程
    ${调用接口}    Create List    可用资金查询_10303001    可用股份查询_10303002    当日委托查询_10303003    当日成交查询_10303004
    log    ----------比对
    ...
    log    ----------取值录制
    ${录制数据}    Create List    当日委托查询_10303003    当日成交查询_10303004    STK_ORDER    STK_MATCHING    STK_ORDER_DETAIL    CUACCT_FUND_DETAIL    CUACCT_FUND_BORROW    港股通汇率信息查询_10301053    港股通标的证券状态查询_10301059    港股通二级资金台账查询_10303027
