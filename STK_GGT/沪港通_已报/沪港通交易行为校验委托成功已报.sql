...
--增强限价交易时间段沪深市场股东：委托130港股通买入,131港股通卖出，选择交易行为为140竞价限价委托成交
...
OR  (@time BETWEEN  (SELECT BGN_TIME FROM STK_TRD_TIMESLICE WHERE TIMESLICE ='7' AND TIMESLICE_NAME = '港股通下午开盘') AND (SELECT END_TIME FROM STK_TRD_TIMESLICE WHERE TIMESLICE ='7' AND TIMESLICE_NAME = '港股通下午开盘'))  AND CUACCT_CODE NOT IN ('11')
--竞价限价时间段沪深市场股东：委托130港股通买入,131港股通卖出，选择交易行为为100竞价限价委托成交
UNION
...
--增强限价时间段沪深市场股东：委托130港股通买入,131港股通卖出，选择交易行为为140竞价限价委托成功，接交易所撮合废单
UNION 
