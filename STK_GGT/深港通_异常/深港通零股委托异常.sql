...
SELECT TOP 1 '深港通买入零股失败' AS name,'尚不支持' AS result,A.*  FROM CTE_Zero1_130_141 A 
UNION 
SELECT TOP 1 '不存在小于港股整手数的持仓,零股卖出失败' AS name,'不存在零股' AS result,A.*  FROM CTE_Zero2_131_141 A