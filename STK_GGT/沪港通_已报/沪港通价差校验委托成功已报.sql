...
SELECT top 1 '港股通买入委托价差价位的整数倍，委托正常' AS name,'订单成功' AS result,* FROM CTE_Master_130_140  
UNION
SELECT top 1 '港股通卖出委托价差价位的整数倍，委托正常' AS name,'订单成功' AS result,* FROM CTE_Master_131_140